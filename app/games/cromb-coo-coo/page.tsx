...
export const metadata: Metadata = {
  ...
  description:
    "An illustrated adventure through the world of Cromb Coo Coo. Meet its inhabitants, discover a call and response, and find your way across the roots.",
  openGraph: {
    title: "Cromb Coo Coo — The First Crossing",
    description:
      "A small, strange adventure among floating forests, enormous roots, and unfamiliar friends.",
    images: [
      {
